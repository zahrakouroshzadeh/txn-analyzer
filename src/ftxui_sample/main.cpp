...
// configuration step. It creates a namespace called `txn_analyzer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", txn_analyzer::cmake::project_name, txn_analyzer::cmake::project_version) };
